...
from torchsample.callbacks import EarlyStopping, ReduceLROnPlateau, CSVLogger
...
callbacks = [EarlyStopping(patience=20),
             ReduceLROnPlateau(factor=0.5, patience=5), CSVLogger('logs.csv')]
...
trainer.fit_loader(train_loader, val_loader, num_epoch=100, verbose=1)
